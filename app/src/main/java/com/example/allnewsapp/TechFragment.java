...
public class TechFragment extends Fragment {
    ...
    String api="6b30396f94474562aff24169a012c6fd";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewoftechnology = v.findViewById(R.id.recyclerViewTech);
    ...
    private void findNews(){
        ApiUtilities.getApiInterface().getCategoryNews(country,catagory,100,api).enqueue(new Callback<MainNews>() {
            @Override
